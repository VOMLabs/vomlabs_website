            ...
            {[
              {
                content: (
                  <p className="text-muted-foreground leading-relaxed">
                    These Terms of Service (&quot;TOS&quot;) explain the rules
                    and expectations for using <strong>VOMLabs</strong> software
                    and this website. By accessing or using VOMLabs software,
                ...
                content: (
                  <ul className="space-y-3 text-muted-foreground">
                    ...
                    <li className="flex items-start gap-3">
                      <span className="text-brand-accent mt-1">•</span>
                      <span>
                        You must be of legal age to use this software in your
                        jurisdiction.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-brand-accent mt-1">•</span>
                      <span>
                        You must not violate any applicable laws or infringe
                ...
                content: (
                  <>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      purpose, non-infringement, or uninterrupted/error-free
                      operation.
                    </p>
                  </>
                ),
                ...
                content: (
                  <>
                    <p className="text-muted-foreground leading-relaxed">
                      ...
                      for any damages arising from your use of VOMLabs software,
              ...
              },
              {
                ...
                content: (
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    any part of VOMLabs software at any time. These Terms may be
                    updated, and continued use constitutes acceptance of
                    changes.
                  </p>
                ),
              },
