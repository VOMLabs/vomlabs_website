        ...
        <section className="max-w-3xl mx-auto px-6 py-12 md:py-20">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              Important legal information about VOMLabs and this website.
            </p>
          </motion.div>
                  ...
                  <ul className="space-y-3 text-muted-foreground">
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        ...
                        is a trademark of Microsoft and Mojang. This project is{" "}
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        ...
                        and is supplied &quot;as-is&quot;. Use at your own risk.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-brand-accent mt-1">•</span>
                ...
                content: (
                  <>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      VOMLabs projects and this website are open source. View
                      the source code and license on GitHub.
                    </p>
                    <div className="flex flex-wrap gap-3">
                      <a
                        ...
                        className="px-4 py-2 rounded-lg bg-card border border-border hover:border-brand-accent/50 transition-colors text-sm font-medium"
                      >
                        VOMLabs Organization
                      </a>
                    </div>
                  </>
                ),
