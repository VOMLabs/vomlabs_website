  ...
  return (
    <div className="relative mx-auto flex min-h-[70vh] max-w-7xl flex-col items-center justify-center px-6 pt-32 pb-20 selection:bg-brand-accent/30 selection:text-brand-accent">
      ...
      >
        ...
        <br />
        <span className="mt-2 block font-mono text-destructive text-sm">
      ...
      >
        <button
          className="relative flex items-center gap-3 overflow-hidden rounded-lg border-2 border-transparent bg-destructive px-6 py-3 font-mono font-semibold text-background text-sm transition-all hover:border-brand-accent/40"
          onClick={() => reset()}
          type="button"
        >
          Try again
