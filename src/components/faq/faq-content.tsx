      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          <div className="relative mx-auto max-w-xl">
            ...
            <input
              className="w-full rounded-xl border border-brand-accent/20 bg-card/50 py-3 pr-4 pl-12 text-foreground transition-all placeholder:text-muted-foreground focus:border-brand-accent focus:outline-none focus:ring-1 focus:ring-brand-accent/50"
