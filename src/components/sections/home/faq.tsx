        ...
        return (
          ...
          >
            <button
              ...
              className="group flex w-full items-center justify-between gap-4 px-5 py-4 text-left focus:outline-none"
              onClick={() => toggle(i)}
            >
              <span className="font-mono font-semibold text-foreground transition-colors group-hover:text-brand-accent">
                {faq.question}
              </span>
              <ChevronDownIcon
