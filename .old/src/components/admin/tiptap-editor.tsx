...
const MenuButton = ({
  ...
  <Button
    aria-label={label}
    className="flex size-8 text-muted-foreground hover:bg-muted hover:text-foreground data-[active]:bg-brand-accent/10 data-[active]:text-brand-accent"
...
export function TiptapEditor({
  ...
  const handleSourceChange = useCallback(
    (val: string) => {
      ...
      setSourceText(val);
      const html = sanitizeHtml(micromark(val), {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-border/60 bg-card/20 backdrop-blur-sm">
      ...
      <div className="bg-background/50">
        {showSource ? (
          <Textarea
            className="tiptap min-h-[300px] resize-y border-0 bg-transparent px-4 py-3 font-mono shadow-none"
