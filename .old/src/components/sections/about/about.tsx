  ...
  return (
    <section className="relative overflow-hidden px-6 py-24">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <FadeInView className="mb-24" delay={0.1}>
          <motion.div
          ...
          >
            {stats.map((stat) => (
              <MotionItem key={stat.label} className="h-full">
                <div className="group h-full rounded-2xl border border-border bg-card/30 p-4 transition-all duration-300 hover:border-brand-accent/50 hover:bg-card/50">
        ...
        <FadeInView className="mb-24" delay={0.15}>
          <motion.div
            variants={stagger}
            initial="hidden"
            whileInView="visible"
        ...
        <FadeInView className="mb-24" delay={0.2}>
          <motion.div
            variants={stagger}
            initial="hidden"
            whileInView="visible"
        ...
        <FadeInView className="mb-12" delay={0.25}>
          <motion.div
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              {guarantees.map((guarantee) => (
                <MotionItem key={guarantee.title} className="text-center" direction="scale">
        ...
        <FadeInView className="text-center" delay={0.3}>
          <motion.a
