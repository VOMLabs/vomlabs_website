        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex h-16 items-center justify-between sm:h-20">
            ...
            <div className="flex items-center gap-2">
              <Button
                className="hidden border-border/60 bg-card/50 px-3 py-2 text-muted-foreground hover:border-brand-accent/30 md:flex"
              ...
              <Button
                ...
                className="rounded-lg p-2 text-muted-foreground hover:bg-accent/50 md:hidden"
                onClick={handleOpenSearch}
                size="icon"
                variant="ghost"
              >
              ...
              <Button
                className="hidden bg-brand-accent px-4 py-2 text-background hover:bg-brand-accent/90 md:inline-flex"
                onClick={() => {
              ...
              <Button
                ...
                className="rounded-lg p-2 hover:bg-accent/50 md:hidden"
            ...
            >
              <div className="space-y-1 p-4">
                <motion.div variants={childVariants}>
                  <Button
                    className="flex w-full justify-between rounded-xl px-4 py-3 text-muted-foreground hover:bg-accent/50"
                    onClick={handleOpenSearch}
                    variant="ghost"
                  >
                ...
                >
                  <Button
                    className="w-full bg-brand-accent px-4 py-3 text-background hover:bg-brand-accent/90"
                    onClick={() => {
                      setSocialsModalOpen(true);
                      closeMobile();
                    }}
