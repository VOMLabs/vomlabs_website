        ...
        <section className="mx-auto max-w-3xl px-6">
          ...
          <div className="space-y-6">
            <div className="overflow-hidden rounded-xl border border-border/60 bg-card/20 backdrop-blur-sm">
              ...
              <Input
                className="border-0 bg-transparent px-4 py-3 text-lg shadow-none"
                onChange={(e) => {
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div className="overflow-hidden rounded-xl border border-border/60 bg-card/20 backdrop-blur-sm">
                ...
                <Input
                  className="border-0 bg-transparent px-3 py-2.5 font-mono shadow-none"
                ...
                <div className="flex min-h-[42px] flex-wrap items-center gap-1.5 p-2">
                  {authors.map((a) => (
                    ...
                    >
                      ...
                      {a.name}
                      <Button
                        className="ml-0.5 h-auto p-0 hover:text-destructive"
                  ...
                  <Button
                    className="rounded-md px-2 py-0.5 text-muted-foreground text-xs hover:bg-muted/30"
                  ...
                  <div className="absolute top-full right-0 left-0 z-50 mt-1 overflow-hidden rounded-xl border border-border/60 bg-card shadow-lg backdrop-blur-xl">
                    {authorOptions.length === 0 ? (
                      ...
                      authorOptions.map((opt) => {
                        ...
                        return (
                          <Button
                            className="flex w-full justify-start gap-2 px-3 py-2.5"
                            key={opt.name}
                      ...
                      {showNewAuthor ? (
                        <div className="space-y-2 p-3">
                          ...
                          <div className="flex items-center gap-2">
                            <Button
                              className="bg-success px-3 py-1.5 text-success-foreground hover:bg-success/90"
                        ...
                        <Button
                          className="flex w-full justify-start gap-2 px-3 py-2.5 text-muted-foreground hover:bg-muted/50"
            ...
            <div className="overflow-hidden rounded-xl border border-border/60 bg-card/20 backdrop-blur-sm">
              ...
              <Textarea
                className="border-0 bg-transparent px-4 py-3 shadow-none"
...
export default function AdminBlogSlugPage() {
  return (
    <Suspense
      fallback={
        <div className="relative flex min-h-screen flex-col overflow-hidden pt-20">
